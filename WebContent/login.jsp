...
<script type="text/javascript">
	...
	img.src = "/MyWebApp/yzmServlet?time=" + new Date().getTime();
    }
</script>
<body onload="sendRequest()">

<div class="videozz"></div>
	<video autoplay="" muted="" loop="" poster="./images/fallba1ck.jpg"></video>
    
<div class="box">
	<div class="box-a">
    <div class="m-2">
    	<div class="m-2-1-1"><p ><font color="#FF0000">密码是ikun，你怕是黑粉吧！</font> </p></div>
          <div class="m-2-1">
          
            <form action="/MyWebApp/login/test.html" method="post" >
                ...
                <div class="m-2-2-1">
                   <input type="text" placeholder="请输入验证码" name="ValiImage">
                   <img src="/MyWebApp/yzmServlet" class="yzm" onclick="changeValiImage(this)" style="cursor:pointer" />
                </div>
                <div class="m-2-2">
                   <button type="submit" value="登录" onclick="doPost()" style="cursor:pointer"> 登录
                </button></div>
            </form>
          </div>
    </div>
    ...
    <div class="m-x20"></div>  
    <div class="m-8"></div>
    <div class="m-9"><div class="masked1" id="sx8">淘宝双11数据分析</div></div> 
    <div class="m-11">
...
<%
response.setHeader("refresh", "4;URL=login.html");//这里的3,是你要确定的时间秒URL是要跳转的地址
%>
